  ...
  <EmployeeLayout>
    <template #header>
      <div class="flex justify-between items-center">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Collector Pending Payment</h2>
    ...
    >
      ...
      <template #actions="{ row }">
        <div class="flex flex-wrap gap-2">
          ...
          <PrimaryButton @click="viewCustomer(row.id)">View</PrimaryButton>
...
const customers = ref([
  ...
  },  
  {
    ...
    company_name: "",
    mobile: "09197368832",
    address: "456 Mang St, Legazpi City",
...
const columns = [
  ...
  { field: 'outstanding_balance', header: 'Outstanding Balance', sortable: false },
  { field: 'payment_type', header: 'Payment Type', sortable: false },
