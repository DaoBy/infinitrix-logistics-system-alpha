...
<template>
  ...
  <div class="flex justify-between items-center w-full px-4 md:px-6">
    <!-- Left: Title & Subtitle -->
    <div>
      <h2 class="text-xl font-semibold leading-tight text-gray-800">Add New Warehouse</h2>
      <p class="mt-1 text-sm text-gray-500">
        Create and configure a new warehouse with precise location details.
      </p>
    </div>
                ...
                <div class="space-y-8">
                  ...
                  <div class="flex justify-between items-center pt-4 px-2">
                    ...
                    <PrimaryButton type="submit" :disabled="form.processing">
                      {{ form.processing ? 'Saving...' : 'Save Region' }}
                    </PrimaryButton>
                  </div>
                </div>
              </form>
