<template>
  <EmployeeLayout>
      ...
      <div class="flex justify-between items-center w-full px-6 md:px-8">
        ...
        <div>
          <h2 class="text-xl font-semibold leading-tight text-gray-800">
            Edit Truck: {{ truck.license_plate }}
          </h2>
          <p class="mt-1 text-sm text-gray-500">
            Update truck information and configuration
          </p>
        </div>
    ...
    <Modal :show="showCancelModal" @close="showCancelModal = false">
      <div class="p-5">
        <h2 class="text-lg font-medium text-gray-900">Are you sure you want to discard changes?</h2>
...
const form = useForm({
  ...
  volume_capacity: props.truck.volume_capacity,
  weight_capacity: props.truck.weight_capacity,
  current_volume: props.truck.current_volume,
  current_weight: props.truck.current_weight,
  status: props.truck.status,
  year: props.truck.year?.toString() || '',
  vin: props.truck.vin,
  purchase_date: props.truck.purchase_date,
  purchase_price: props.truck.purchase_price?.toString() || '',
  current_value: props.truck.current_value?.toString() || '',
  notes: props.truck.notes,
  is_active: props.truck.is_active,
  region_id: props.truck.region_id,
});

const submit = () => {
  form.put(route('admin.trucks.update', props.truck.id), {
    preserveScroll: true,
  });
};
